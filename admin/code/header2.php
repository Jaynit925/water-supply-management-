...
if ($_SESSION['role']=="user" and $_SESSION['role']=="" ) {
    // code...
    echo "<script>window.location.href='login.php';</script>";
}
...
<!-- Mirrored from digiboard-html.codebasket.xyz/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jul 2024 12:11:32 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="main-sidebar">
        <div class="main-menu">
            <ul class="sidebar-menu scrollable">
                ...
                <li class="sidebar-item ">
                    ...
                    <ul class="sidebar-link-group">
                        <li class="sidebar-dropdown-item">
                            <a href="index.php" class="sidebar-link "><span class="nav-icon"><i class="fa-light fa-cart-shopping-fast"></i></span> <span class="sidebar-txt">Analysis</span></a>
                        </li>
                       <!--  <li class="sidebar-dropdown-item">
                ...
                <li class="sidebar-item ">
                    <a role="button" class="sidebar-link-group-title has-sub">Services</a>
                    <ul class="sidebar-link-group">
                        <li class="sidebar-dropdown-item">
                            <a href="add_services.php" class="sidebar-link "><span class="nav-icon"><i class="fa-light fa-cart-shopping-fast"></i></span> <span class="sidebar-txt">Add&nbsp;Services</span></a>
                        </li>
                        <li class="sidebar-dropdown-item">
                            <a href="manage_services.php" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-user-headset"></i></span> <span class="sidebar-txt">Manage&nbsp;Services</span></a>
                        </li>
                ...
                <li class="sidebar-item ">
                    ...
                    <ul class="sidebar-link-group">
                        ...
                        <li class="sidebar-dropdown-item">
                            <a href="manage_order.php" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-user-headset"></i></span> <span class="sidebar-txt">Manage&nbsp;Booking</span></a>
                        </li>
                ...
                <li class="sidebar-item ">
                    <a role="button" class="sidebar-link-group-title has-sub">News</a>
                    <ul class="sidebar-link-group">

                         <li class="sidebar-dropdown-item">
                            <a href="add_news.php" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-user-headset"></i></span> <span class="sidebar-txt">Add&nbsp;News</span></a>
                        </li>

                        <li class="sidebar-dropdown-item">
                            <a href="manage_news.php" class="sidebar-link "><span class="nav-icon"><i class="fa-light fa-cart-shopping-fast"></i></span> <span class="sidebar-txt">Manage&nbsp;News</span></a>
                        </li>
                 ...
                 <li class="sidebar-item ">
                    <a role="button" class="sidebar-link-group-title has-sub">About Us</a>
                    <ul class="sidebar-link-group">
                        <li class="sidebar-dropdown-item">
                            <a href="about_us.php" class="sidebar-link "><span class="nav-icon"><i class="fa-light fa-cart-shopping-fast"></i></span> <span class="sidebar-txt">Manage&nbsp;About&nbsp;Us</span></a>
                        </li>
                 ...
                 <li class="sidebar-item ">
                    <a role="button" class="sidebar-link-group-title has-sub">Contact Details</a>
                    <ul class="sidebar-link-group">
                        <li class="sidebar-dropdown-item">
                            <a href="manage_contact.php" class="sidebar-link "><span class="nav-icon"><i class="fa-light fa-cart-shopping-fast"></i></span> <span class="sidebar-txt">Manage&nbsp;Contact&nbsp;Details</span></a>
                        </li>
                 ...
                 <li class="sidebar-item ">
                    <a role="button" class="sidebar-link-group-title has-sub">Manage Payment</a>
                    <ul class="sidebar-link-group">
                        <li class="sidebar-dropdown-item">
                            <a href="manage_payment.php" class="sidebar-link "><span class="nav-icon"><i class="fa-light fa-cart-shopping-fast"></i></span> <span class="sidebar-txt">Manage&nbsp;Payment</span></a>
                        </li>
