...
.sidebar-item.active .sidebar-link-group {
    display: block;
}

.sidebar-item.active .sidebar-link-group-title {
    background-color: #4CAF50;
}
...
/* Hover Effect */
.sidebar-item:hover .sidebar-link-group-title {
...
<?php 
                                ...
                                while ($row = mysqli_fetch_assoc($run)) {
                                    ...
                                    $del='code/delete.php?tbl=contact&id='.$id.'&url=index.php';
echo '
                                        ...
                                        <li>
                                            <a href="#" class="d-flex">
                                                ...
                                                <div class="msg-txt">
                                                    ...
                                                    <span class="msg-short">'.$message.'</span>
                                                    <span style="display:flex;" class="time">2 Hours ago  &nbsp;&nbsp;<span class="fa-light fa-trash" onclick="window.location=`'.$del.'`;" ></span></span>
...
?>
   ...
   <?php 
   $ids=$_SESSION['id'];
$ss="SELECT `id`, `full_name`, `username`, `biography`, `role`, `status`, `email`, `phone`, `website`, `address`, `profile_picture` FROM `profile` where id=$ids";
$run=mysqli_query($con,$ss);
$user=mysqli_fetch_assoc($run);
                                 ?>
                    <div class="header-btn-box profile-btn-box">
                        <button class="profile-btn" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="upload/profile_pictures/<?php echo $user['profile_picture']; ?>" alt="image">
                        </button>
                        <ul class="dropdown-menu profile-dropdown-menu">
                            <li>
                                <div class="dropdown-txt text-center">
                                    <p class="mb-0"><?php echo $user['full_name']; ?></p>
                                    <span class="d-block"><?php echo $user['role']; ?></span>
                                  
                                </div>
                            </li>
                            <li><a class="dropdown-item" href="profile.php?id=<?php echo($_SESSION['id']) ?>"><span class="dropdown-icon"><i class="fa-regular fa-circle-user"></i></span> Profile</a></li>
        ...
        <ul class="sidebar-menu scrollable">
            ...
            <li class="sidebar-item">
                ...
                <ul class="sidebar-link-group">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="manage_services.php" class="sidebar-link">
                            <i class="fa-solid fa-clipboard-list"></i> Manage Services
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="sidebar-link-group">
                    <li class="sidebar-dropdown-item">
                        <a href="manage_order.php" class="sidebar-link">
                            <i class="fa-solid fa-calendar-alt"></i> Manage Booking
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul class="sidebar-link-group">
                    <li class="sidebar-dropdown-item">
                        <a href="add_news.php" class="sidebar-link">
                            <i class="fa-solid fa-plus-circle"></i> Add News
                        </a>
                    </li>
                    <li class="sidebar-dropdown-item">
                        <a href="manage_news.php" class="sidebar-link">
                            <i class="fa-solid fa-edit"></i> Manage News
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="sidebar-link-group">
                    <li class="sidebar-dropdown-item">
                        <a href="about_us.php" class="sidebar-link">
                            <i class="fa-solid fa-pencil-alt"></i>&nbsp; Manage About Us
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul class="sidebar-link-group">
                    <li class="sidebar-dropdown-item">
                        <a href="manage_contact.php" class="sidebar-link">
            ...
            <li class="sidebar-item">
                <a role="button" class="sidebar-link-group-title has-sub">
                    <i class="fa-solid fa-credit-card"></i>&nbsp; Manage Payment
                </a>
                <ul class="sidebar-link-group">
                    <li class="sidebar-dropdown-item">
                        <a href="manage_payment.php" class="sidebar-link">
                            <i class="fa-solid fa-dollar-sign"></i> Manage Payment
                        </a>
                    </li>
                </ul>
            </li>
