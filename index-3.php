 ...
 ?>
    ...
    <div class="banner_area1 clearfix">
        ...
        <div class="camera_wrap " id="banner_slider1">
            <div class="hero_slider" data-src="assets/img/banner/h3-banner1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <!-- banner text wrap -->
            ...
            <div class="hero_slider" data-src="assets/img/banner/h3-banner2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <!-- banner text wrap -->
    ...
    <!-- our quality -->
    <section class="pt-120 pb-120 quality" data-bg-img='assets/img/qulity.png'>
        <div class="container">
            <div class="row">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="single-bottle-inner text-center">
                        ...
                        <div class="single-bottle-text">
                            ...
                            <a href="service-details.php"><i class="fa fa-arrow-circle-o-right"></i>Order</a>
                        </div>
                ...
                <div class="col-12">
                    <div class="deliver-btn text-center">
                        <a href="service.php" class="btn">View all Bottle</a>
                    </div>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container -->
    ...
    <section class="pt-120 pb-130 blue-bg2">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="testionial-carousel-wrap style3">
                    ...
                    <div class="our-location-wrap text-center">
                        ...
                        <div class="our-location marker1">
                            <div class="our-location-details">
                                ...
                                <a href="0008888999.php">000 8888 999</a>
                                <a href="needhelp%40mineralo.php">needhelp@mineralo.com</a>
                            </div>
                        </div>
    ...
    <!-- call to action area -->
    <section class="pt-110 pb-100 blue-bg">
        <div class="container">
...
<!-- Mirrored from pixydrops.com/mineralo/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Jul 2024 12:47:58 GMT -->
</html>